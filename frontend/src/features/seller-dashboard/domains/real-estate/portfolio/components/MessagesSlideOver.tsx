              ...
              <div className="p-4 border-t border-slate-200 bg-white">
                <div className="flex gap-2">
                  ...
                  <button
                    ...
                    className="px-4 py-2 bg-gradient-to-r from-brand-500 to-cyan-500 text-white rounded-xl shadow-lg hover:shadow-xl
                             disabled:bg-slate-300 disabled:opacity-50 disabled:cursor-not-allowed transition-all
